...
let AdminProfile = class AdminProfile extends typeorm_1.BaseEntity {
};
__decorate([
...
], AdminProfile.prototype, "login", void 0);
__decorate([
    (0, type_graphql_1.Field)(),
...
__decorate([
    ...
    (0, typeorm_1.OneToOne)(() => User_1.User, (user) => user.adminProfile, {
        onDelete: "CASCADE",
    }),
